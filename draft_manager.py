...
class DraftManager:
    ...
    def _init_structures(self):
        ...
        draft_cfg = self.data["settings"]["llm_servers"].setdefault(
            "drafting", {"provider": "openai", "model": "gpt-4o", "api_key": ""}
        )
    ...
    def add_scene(
        self, chapter_id: str, title: str, order: Optional[int] = None
    ...
    def delete_chapter(self, chapter_id: str) -> bool:
        ...
        self.manuscript["chapters"] = [
            c for c in chapters if c["chapter_id"] != chapter_id
        ]
    ...
    def save_drafting_configs(
        self, story_blueprint: List[Dict[str, Any]], directing_settings: Dict[str, Any]
    ):
