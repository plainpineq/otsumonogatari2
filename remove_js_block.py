...
file_path = r'D:\Python\src\otsumonogatari\templates\document.html' # Use raw string for path
...
try:
    ...
    modified_content, num_replacements = re.subn(pattern, "", content, flags=re.DOTALL | re.IGNORECASE)

    if num_replacements > 0:
        with open(file_path, 'w', encoding='utf-8') as f:
            f.write(modified_content)
        print(f'Successfully removed {num_replacements} JavaScript ad blocks from {file_path}')
    else:
